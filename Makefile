diff:
	...
	ssh jar@arkko.eu 'cd /tmp; rfcdiff draft-arkko-eap-aka-pfs-03.txt draft-arkko-eap-aka-pfs.txt'
	scp jar@arkko.eu:/tmp/draft-arkko-eap-aka-pfs-from--03.diff.html .
	scp draft-arkko-eap-aka-pfs.txt \
	    draft-arkko-eap-aka-pfs-from--03.diff.html \
