...
diff:
	...
	ssh jar@$(SERVER) 'cd /tmp; rfcdiff draft-ietf-emu-aka-pfs-02.txt draft-arkko-eap-aka-pfs.txt; mv -i draft-arkko-eap-aka-pfs-from-ietf-emu-aka-pfs-02.diff.html draft-ietf-emu-aka-pfs-from--02.diff.html'
	scp jar@$(SERVER):/tmp/draft-ietf-emu-aka-pfs-from--02.diff.html .
	scp draft-arkko-eap-aka-pfs.txt \
	    draft-ietf-emu-aka-pfs-from--02.diff.html \
